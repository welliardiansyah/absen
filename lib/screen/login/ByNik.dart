...
class ByNikScreen extends StatefulWidget {
  @override
  _ByNikScreen createState() => _ByNikScreen();
}

class _ByNikScreen extends State<ByNikScreen> {
  ...
  void _login() async {
    ...
    if (nik.isEmpty || password.isEmpty) {
      _showDialog('Login Failed', 'NIK atau Password tidak boleh kosong!.');
      return;
    }
    ...
    try {
      ...
      var response = await _apiService.loginByNik(nik, password);
      if (response.statusCode == 200) {
        ...
        Navigator.pop(context);
        _showDialog('Login Failed', 'Invalid NIK or password.');
      } else {
        Navigator.pop(context);
